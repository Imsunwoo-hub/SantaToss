...
# 학습 데이터 시각화
plt.scatter(x_data, y_data, c=np.random.random(len(y_data)), cmap=plt.cm.rainbow)
plt.show()
...
# 결과 시각화
plt.scatter(x_data, y_data, s=5, label="train data", c=np.random.random(len(y_data)), cmap=plt.cm.rainbow)
